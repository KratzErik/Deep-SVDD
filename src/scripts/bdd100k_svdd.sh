...
# Experiment config mainly set in bdd100k part of config.py
# Run experiment with sh bdd100k_svdd.sh gpu bdd100k/your_folder_spec 0 adam 0.0001 150 1 0 1 0
